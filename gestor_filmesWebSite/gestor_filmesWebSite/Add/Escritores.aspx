<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Escritores.aspx.cs" Inherits="gestor_filmesWebSite.Add.Escritores" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">



    <br />
    <h2> <i class="glyphicon glyphicon-plus"></i>  Adicionar Escritor </h2>
    <br />
 ...
 <br /> <br />
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
            <asp:TextBox runat="server" placeholder="DD-MM-AAAA" ID="TextBox4" CssClass="form-control" />
        </div>
    </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><img style="width: 7%; height: 7%"" src="https://cdn0.iconfinder.com/data/icons/round-ui-icons/512/tick_green.png" alt="Mountain View" style="width:174px;">Escritor adicionado com sucesso!</h4>
                </div>
